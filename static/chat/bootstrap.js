...
const sessionProfileControl = document.getElementById("sessionProfileControl");
const standardProfileBtn = document.getElementById("standardProfileBtn");
...
try {
  localStorage.removeItem("preferredAgentTemplateId");
  localStorage.removeItem("preferredAgentTemplateName");
} catch {}
