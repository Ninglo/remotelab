...
function printHelp(stdout = process.stdout) {
  stdout.write('Model policy: --runtime-policy follow_default|fixed. With no runtime overrides, new execution Sessions use the latest Default; reused Sessions keep their model. Explicit --tool/--model/--effort pins the profile.\n\n');
