...
export const DEFAULT_JEV_TIER_PROFILES = Object.freeze({
  quality: Object.freeze({ model: 'gpt-5.6-sol', effort: 'high' }),
  balanced: Object.freeze({ model: 'gpt-5.6-terra', effort: 'medium' }),
  economy: Object.freeze({ model: 'gpt-5.6-luna', effort: 'low' }),
});
...
const QUESTIONS = Object.freeze({
  service_tier: {
    type: 'choice',
    instructions: 'Route the entire new RemoteLab Session, not merely the apparent size of its first message. Choose quality by default. Downgrade only with affirmative evidence that the whole task fits a lower tier. Short prompts can begin serious work. Treat Chinese and English equivalents the same.',
    criteria: {
