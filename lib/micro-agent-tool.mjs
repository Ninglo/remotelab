...
function resolveCodexReasoningLevels(modelId) {
  ...
  if (normalized === 'gpt-5.6-luna') return MICRO_AGENT_GPT56_LUNA_REASONING_LEVELS;
  if (normalized === 'gpt-6-astra' || normalized === 'gpt-5.6' || normalized === 'gpt-5.6-sol' || normalized === 'gpt-5.6-terra') {
