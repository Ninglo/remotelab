...
function buildConvergedLaunchAgentSpec(agent = {}, options = {}) {
  ...
  const desiredInstanceRoot = trimString(agent.instanceRoot)
    ...
    || trimString(environmentVariables.REMOTELAB_INSTANCE_ROOT)
    || (name ? join(DEFAULT_GUEST_INSTANCES_ROOT, name) : '');
  environmentVariables.REMOTELAB_INSTANCE_ROOT = desiredInstanceRoot;
  environmentVariables.HOME = trimString(environmentVariables.REMOTELAB_INSTANCE_ROOT) || HOME_DIR;
  ...
  environmentVariables.REMOTELAB_MACHINE_CODEX_HOME = '/root/.codex';
