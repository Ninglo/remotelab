...
- If future-time orchestration still temporarily requires an AI-backed trigger, it gets its own execution session; never inject its control prompt into the conversation where the reminder was requested.
