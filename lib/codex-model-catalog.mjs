...
export const CODEX_MODEL_CATALOG = Object.freeze([
  { id: 'gpt-6-astra', label: 'GPT-6 Astra', effortLevels: ['low', 'medium', 'high', 'xhigh', 'max', 'ultra'], defaultEffort: 'xhigh', contextWindow: 272000 },
  { id: 'gpt-6-sol', label: 'GPT-6 Sol', effortLevels: ['low', 'medium', 'high', 'xhigh', 'max', 'ultra'], defaultEffort: 'low', contextWindow: 272000 },
  { id: 'gpt-6-luna', label: 'GPT-6 Luna', effortLevels: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', contextWindow: 272000 },
