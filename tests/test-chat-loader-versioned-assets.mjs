...
assert.deepEqual(
  ...
  [
    ...
    '/chat/activity-ui.js?v=build-123',
    '/chat/session-surface-ui.js?v=build-123',
    '/chat/session-list-ui.js?v=build-123',
    '/chat/instance-settings.js?v=build-123',
    '/chat/voice-input.js?v=build-123',
    '/chat/settings-ui.js?v=build-123',
    '/chat/task-center.js?v=build-123',
...
assert.deepEqual(
  ...
  [
    ...
    '/chat/activity-ui.js?v=inline-build-456',
    '/chat/session-surface-ui.js?v=inline-build-456',
    '/chat/session-list-ui.js?v=inline-build-456',
    '/chat/instance-settings.js?v=inline-build-456',
    '/chat/voice-input.js?v=inline-build-456',
    '/chat/settings-ui.js?v=inline-build-456',
    '/chat/task-center.js?v=inline-build-456',
...
assert.deepEqual(
  ...
  [
    ...
    '/owner/chat/activity-ui.js?v=build-123',
    '/owner/chat/session-surface-ui.js?v=build-123',
    '/owner/chat/session-list-ui.js?v=build-123',
    '/owner/chat/instance-settings.js?v=build-123',
    '/owner/chat/voice-input.js?v=build-123',
    '/owner/chat/settings-ui.js?v=build-123',
    '/owner/chat/task-center.js?v=build-123',
