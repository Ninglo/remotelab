...
(function attachRemoteLabI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "settings.theme.note": "Choose the chat color palette. Default keeps the current system light or dark appearance; Amber applies a warm light palette without changing layout.",
      "settings.theme.ariaLabel": "Choose chat theme",
      "settings.theme.optionSystem": "Default (follow system)",
      "settings.theme.optionAmber": "Amber",
      ...
      "context.liveShort": "{tokens} context · {percent}",
      "context.liveOnly": "{tokens} context",
      "context.liveTitle": "Context: {context}",
      "context.liveTitleWithWindow": "Context: {context} / {window} ({percent})",
      "context.usage.live": "{tokens} context",
    ...
    "zh-CN": {
      ...
      "settings.theme.note": "选择对话界面的配色。默认会跟随系统当前的明暗外观；Amber 会切到一套偏暖的浅色配色，不改布局。",
      "settings.theme.ariaLabel": "选择对话主题",
      "settings.theme.optionSystem": "默认（跟随系统）",
      "settings.theme.optionAmber": "Amber",
      ...
      "context.liveShort": "{tokens} 上下文 · {percent}",
      "context.liveOnly": "{tokens} 上下文",
      "context.liveTitle": "上下文：{context}",
      "context.liveTitleWithWindow": "上下文：{context} / {window}（{percent}）",
      "context.usage.live": "{tokens} 上下文",
