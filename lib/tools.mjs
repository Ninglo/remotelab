...
const SIMPLE_RUNTIME_FAMILIES = new Set(['claude-stream-json', 'codex-json', 'pi-json']);
...
export async function saveSimpleToolAsync({ name, command, runtimeFamily, models, reasoning, visibility }) {
  ...
  if (!normalizedFamily) {
    throw new Error('runtimeFamily must be one of: claude-stream-json, codex-json, pi-json');
  }
