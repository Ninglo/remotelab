...
(function attachRemoteLabI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "settings.install.note": "Open the install flow and keep a short diagnostics trail here.",
      "settings.install.open": "Install RemoteLab",
      "settings.install.promptReady": "Open Install Prompt",
      "settings.install.clearLog": "Clear Log",
      "settings.install.logEmpty": "No install diagnostics yet.",
      ...
      "settings.install.statusFallback": "No browser install prompt yet. The button will reopen the install flow with diagnostics.",
      "settings.install.statusDesktop": "This browser is not a mobile install target, but install diagnostics still appear here.",
      ...
      "settings.apps.builderMissing": "Create Agent starter is unavailable right now.",
    ...
    "zh-CN": {
      ...
      "settings.install.note": "从这里直接走安装流程，并把关键诊断日志保存在这里。",
      "settings.install.open": "安装 RemoteLab",
      "settings.install.promptReady": "打开安装弹窗",
      "settings.install.clearLog": "清空日志",
      "settings.install.logEmpty": "还没有安装诊断日志。",
      "settings.install.statusStandalone": "这个设备上的 RemoteLab 已经在独立应用模式里运行。",
      "settings.install.statusPromptReady": "当前浏览器已经拿到了安装弹窗。",
      "settings.install.statusFallback": "浏览器还没给安装弹窗，这个按钮会带着诊断日志重走安装链路。",
      "settings.install.statusDesktop": "当前不是移动端安装目标浏览器，但诊断日志仍会显示在这里。",
      ...
      "settings.apps.builderMissing": "当前无法找到 Create Agent builder。",
