const MODEL_PRICING = Object.freeze({
  'gpt-6-astra': Object.freeze({
    ...
    costSource: 'estimated_gpt_6_astra',
  ...
  'gpt-6-sol': Object.freeze({
    ...
    costSource: 'estimated_gpt_6_sol',
    inputIncludesCachedTokens: true,
  }),
  'gpt-6-luna': Object.freeze({
    ...
    costSource: 'estimated_gpt_6_luna',
    inputIncludesCachedTokens: true,
  }),
  'gpt-5.6-sol': Object.freeze({
    pricingModel: 'gpt-5.6-sol',
    // Official promotional Standard rates, available at least through 2026-11-21.
    inputUsdPerMillion: 4,
    cachedInputUsdPerMillion: 0.4,
    cacheWriteUsdPerMillion: 5,
    outputUsdPerMillion: 20,
    costSource: 'estimated_gpt_5_6_sol',
    inputIncludesCachedTokens: true,
  }),
  'gpt-5.6-terra': Object.freeze({
    ...
    costSource: 'estimated_gpt_5_6_terra',
    inputIncludesCachedTokens: true,
  }),
  'gpt-5.6-luna': Object.freeze({
    ...
    costSource: 'estimated_gpt_5_6_luna',
    inputIncludesCachedTokens: true,
  }),
  ...
  'claude-sonnet-5': Object.freeze({
    ...
    cachedInputUsdPerMillion: 0.2,
    outputUsdPerMillion: 10,
    costSource: 'estimated_claude_sonnet_5',
  ...
  'claude-fable-5-1': Object.freeze({
    ...
    cachedInputUsdPerMillion: 0.25,
    outputUsdPerMillion: 50,
    costSource: 'estimated_claude_fable_5_1',
    inputIncludesCachedTokens: false,
  }),
  'claude-fable-5': Object.freeze({
    ...
    cachedInputUsdPerMillion: 1,
    outputUsdPerMillion: 50,
    costSource: 'estimated_claude_fable_5',
    inputIncludesCachedTokens: false,
  }),
  'claude-opus-5-5': Object.freeze({
    ...
    cachedInputUsdPerMillion: 0.2,
    outputUsdPerMillion: 20,
    costSource: 'estimated_claude_opus_5_5',
    inputIncludesCachedTokens: false,
  }),
  'claude-opus-5': Object.freeze({
    ...
    costSource: 'estimated_claude_opus_5',
    inputIncludesCachedTokens: false,
  }),
  'claude-opus-4.8': Object.freeze({
    ...
    cachedInputUsdPerMillion: 0.5,
    outputUsdPerMillion: 25,
    costSource: 'estimated_claude_opus_4_8',
    inputIncludesCachedTokens: false,
  }),
  'claude-opus-4.7': Object.freeze({
    ...
    cachedInputUsdPerMillion: 0.5,
    outputUsdPerMillion: 25,
    costSource: 'estimated_claude_opus_4_7',
    inputIncludesCachedTokens: false,
  }),
...
function resolveClaudePricingModel(normalizedModel) {
  ...
  if (matchExactModel(normalizedModel, 'fable', 'claude-fable', 'claude-fable-latest')
    || matchModelPrefix(normalizedModel, 'claude-fable-5-1')) {
    return 'claude-fable-5-1';
  }
  if (matchModelPrefix(normalizedModel, 'claude-fable-5')) {
    return 'claude-fable-5';
  }

  if (matchExactModel(normalizedModel, 'sonnet', 'claude-sonnet', 'claude-sonnet-latest')
    || matchModelPrefix(normalizedModel, 'claude-sonnet-5', 'claude-sonnet-5-')) {
    return 'claude-sonnet-5';
  }
  if (matchModelPrefix(normalizedModel, 'claude-sonnet-4.6', 'claude-sonnet-4-6')) {
  ...
  if (matchExactModel(normalizedModel, 'opus', 'claude-opus', 'claude-opus-latest')
    || matchModelPrefix(normalizedModel, 'claude-opus-5-5')) {
    return 'claude-opus-5-5';
  }
  if (matchModelPrefix(normalizedModel, 'claude-opus-5')) {
    return 'claude-opus-5';
  }
  if (matchModelPrefix(normalizedModel, 'claude-opus-4-8', 'claude-opus-4.8')) {
    return 'claude-opus-4.8';
  }
  if (matchModelPrefix(normalizedModel, 'claude-opus-4-7', 'claude-opus-4.7')) {
    return 'claude-opus-4.7';
  }
  if (matchModelPrefix(normalizedModel, 'claude-opus-4.6', 'claude-opus-4-6')) {
...
export function resolvePricingMetadata(model, options = {}) {
  ...
  if (matchExactModel(normalizedModel, 'gpt-6-astra')) {
    return MODEL_PRICING['gpt-6-astra'];
  }
  if (matchExactModel(normalizedModel, 'gpt-6-sol')) {
    return MODEL_PRICING['gpt-6-sol'];
  }
  if (matchExactModel(normalizedModel, 'gpt-6-luna')) {
    return MODEL_PRICING['gpt-6-luna'];
  }
  if (matchExactModel(normalizedModel, 'gpt-5.6', 'gpt-5.6-sol')) {
    return MODEL_PRICING['gpt-5.6-sol'];
  }
  if (matchExactModel(normalizedModel, 'gpt-5.6-terra')) {
    return MODEL_PRICING['gpt-5.6-terra'];
  }
  if (matchExactModel(normalizedModel, 'gpt-5.6-luna')) {
    return MODEL_PRICING['gpt-5.6-luna'];
  }
  if (matchExactModel(normalizedModel, 'gpt-5.5')) {
    return MODEL_PRICING['gpt-5.5'];
  }
  if (matchExactModel(normalizedModel, 'gpt-5.2')) {
