...
be changed after creation. It prefers answering from supplied context and avoids
unrequested tool use that would add latency, while retaining tools for requests
that explicitly ask for or genuinely require them.
