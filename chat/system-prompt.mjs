...
- For cheap high-frequency monitoring, gate Agent admission with a local script: \`remotelab schedule create --every 30s --gate-file ./check.sh --times 5 --text "<task when matched>" --json\`. The script prints exactly \`yes\`, \`no\`, or strict JSON with a boolean \`trigger\`; gate failures do not wake an Agent.
