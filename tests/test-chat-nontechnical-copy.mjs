...
assert.match(i18nSource, /"settings\.sessionPresentation\.entryMode\.resume": "Open at latest turn"/);
...
assert.match(i18nSource, /"settings\.sessionPresentation\.entryMode\.resume": "打开到最新一轮开头"/);
